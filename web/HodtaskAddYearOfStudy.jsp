...
<div class="container">
    <form action="AddYearOfStudy" method="post">
  <form class="form-horizontal" action="" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="yearID">YearID:</label>
      <div class="col-sm-10">
        <input type="number" class="form-control" id="yearID"required="required" placeholder="Enter yearID" name="yearID">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="yearname">YearName:</label>
      <div class="col-sm-10">          
        <select class="form-control" id="category"required="required" placeholder="Select yearname" name="year_name">
        <option>  </option>    
