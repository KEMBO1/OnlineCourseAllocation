                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="HodtaskAddSemesterOfStudy"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i></i>Add Lecturer</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ViewYearOfStudy"  aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i></i>Add Year Of Study</a>
