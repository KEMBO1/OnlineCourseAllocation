      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            <a href="Adminlogin.jsp" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-unlock-alt"></span> Log In</a>
        ...
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              ...
              <p>Login in to the system as an Administrator.</p>
            </div>
          </div>
        </div>
      </div> 
